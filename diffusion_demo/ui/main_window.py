...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSaveGenerated.setIcon(icon17)
        ...
        self.actionRandomImage = QtWidgets.QAction(MainWindow)
        self.actionRandomImage.setIcon(icon18)
        self.actionRandomImage.setObjectName("actionRandomImage")
        ...
        self.menuFile.addAction(self.actionRandomImage)
        ...
        self.fileToolbar.addAction(self.actionRandomImage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRandomImage.setText(_translate("MainWindow", "Random Image"))
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, args, config):
        ...
        self.generate_button.setIcon(QtGui.QIcon("ui/icons/arrow-000.png"))
        self.generate_button.setMinimumSize(25, 10)
        self.generate_button.setStyleSheet("QPushButton{border: 0px solid;}")
        self.generate_button.clicked.connect(self.generate)

        self.apply_button = QtWidgets.QPushButton(self)
        self.apply_button.setIcon(QtGui.QIcon("ui/icons/arrow-180.png"))
        self.apply_button.setMinimumSize(25, 10)
        self.apply_button.setStyleSheet("QPushButton{border: 0px solid;}")
        ...
        self.horizontalLayout.addLayout(button_layout)

        self.display_pad = DisplayPad(self, self.canvas, args, config)
        ...
        self.fontselect = QtWidgets.QFontComboBox()
        ...
        self.fontselect.setCurrentFont(QtGui.QFont("Times"))
        ...
        sizeicon = QtWidgets.QLabel()
        sizeicon.setPixmap(QtGui.QPixmap(":/icons/border-weight.png"))
        self.drawingToolbar.addWidget(sizeicon)
        self.sizeselect = QtWidgets.QSlider()
        self.sizeselect.setRange(1, 20)
        self.sizeselect.setOrientation(QtCore.Qt.Horizontal)
    ...
    def open_file_with_path(self, path):
        if path:
            ...
            if iw / cw < ih / ch:  # The height is relatively bigger than the width.
                ...
                pixmap = pixmap.copy(QtCore.QRect(QtCore.QPoint(0, hoff), QtCore.QPoint(cw, pixmap.height() - hoff)))

            elif iw / cw > ih / ch:  # The height is relatively bigger than the width.
                pixmap = pixmap.scaledToHeight(ch)
                woff = (pixmap.width() - cw) // 2
                pixmap = pixmap.copy(QtCore.QRect(QtCore.QPoint(woff, 0), QtCore.QPoint(pixmap.width() - woff, ch)))

            self.set_base_image(pixmap)
    ...
    def open_file(self):
        ...
        path, _ = QtWidgets.QFileDialog.getOpenFileName(
            self, "Open file", "", "PNG image files (*.png); JPEG image files (*jpg); All files (*.*)"
        )
        self.open_file_with_path(path)

    def random_file(self):
        try:
            root = os.path.join("images", self.args.dataset)
    ...
    def save_file(self):
        ...
        :return:
        """
        path, _ = QtWidgets.QFileDialog.getSaveFileName(self, "Save edited file", "", "PNG Image file (*.png)")
    ...
    def save_generated(self):
        path, _ = QtWidgets.QFileDialog.getSaveFileName(self, "Save generated file", "", "PNG Image file (*.png)")
    ...
    def invert(self):
        img = QtGui.QImage(self.canvas.pixmap())
        img.invertPixels()
        pixmap = QtGui.QPixmap()
    ...
    def flip_horizontal(self):
        pixmap = self.canvas.pixmap()
        self.canvas.setPixmap(pixmap.transformed(QtGui.QTransform().scale(-1, 1)))
    ...
    def apply(self):
        self.display_pad.apply()

    def set_base_image(self, pixmap):
        image_numpy = pixmap2numpy(pixmap)
        image_tensor = torch.from_numpy(image_numpy).float().permute(2, 0, 1) / 255.0
        image_tensor = image_tensor.unsqueeze(0).to(self.config.device)
        self.canvas.set_base_image(image_numpy)
        self.display_pad.set_base_image(image_tensor)
